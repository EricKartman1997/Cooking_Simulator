...
public class BootstrapLVL2 : MonoBehaviour
{
    ...
    private IEnumerator Initialize()// переделать
    {
       ...
       // _eventBus = new EventBus();
        ...
        //_managerMediator = new ManagerMediator(this);
        //_dataManager = new DataManager();
        
        //_checksManager = new ChecksManager(this);
        //_updateChecks = new UpdateChecks(_checksManager,3f,this);
       // _orders = new Orders(this);
        ...
        //     _dataManager,_managerMediator,_checksManager,_score,_updateChecks,_orders,
    ...
    //     // //yield return new WaitUntil(() => _checksManager.IsInit);
    ...
    //     //yield return new WaitUntil(() => _managerMediator.IsInit);
    ...
    //     // return new WaitUntil(() => checksFactory.IsInit);
