public static class JsonPathName
{
    ...
    public const string FURNITURE_ITEMS_PATH = "furniture_items";
    public const string FURNITURE_TRAINING_ITEMS_PATH = "furniture_training_items";
